...
- 成系列内容足够多
- 主角不变利于听懂
- 对话/讲述/演讲为主, 内容密集有主题/故事, 避开空洞教学内容
- 5-20 分钟时长
- ~~有精准人工字幕~~ [^subtitle]
...
Dan Koe 使用正常语速, 会出现无法跟上的情况; 不要改用慢速素材或者降低播放速度, 可暂停播放只阅读, 直至熟悉文字后再听看, 要从开始就熟悉母语者正常语速.
...
PS: 推荐首篇的句子并不简单, 理解是有难度的, 程序翻译也有偏差错误, 似乎不适合初学者; 但这是为了在枯燥重复中享受逐步破解理解的成就感, 耐住性子从单词->短语->句子->整篇逐层牢固理解掌握.
